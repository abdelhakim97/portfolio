...
function Work({ position, company, location, type, duration,description,img,SKILLS,link }) {
  return (
    <article className=" border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      <div>
        <img  src={img}  /> 
        <span><a  className="text-gray-500" href={link}>{link}</a></span> <br/><br/>
      </div>
      ...
      <br />
      <div className="text-blue-500 md:text-green-500">
        Skills : {SKILLS}
      </div>
